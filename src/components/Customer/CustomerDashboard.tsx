...
const CustomerDashboard: React.FC = () => {
  const stats = [
    { label: 'Jobs Posted', value: '12', icon: Briefcase, color: 'blue' },
    { label: 'Active Jobs', value: '3', icon: Clock, color: 'yellow' },
    { label: 'Completed', value: '9', icon: CheckCircle, color: 'green' },
    { label: 'Total Spent', value: '$3,500', icon: DollarSign, color: 'purple' }
  ];
